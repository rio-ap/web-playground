...
- 113 unit tests (including the CI path-to-tag mapping), 174 Playwright runs across three browsers (58 each), plus 7 chromium a11y audits and 1 smoke test — fast enough to run on every PR
